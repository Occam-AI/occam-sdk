...
from occam_sdk.api_response import ApiResponse, T as ApiResponseT
import occam_sdk.models
from occam_sdk import rest
from occam_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(occam_sdk.models, klass)

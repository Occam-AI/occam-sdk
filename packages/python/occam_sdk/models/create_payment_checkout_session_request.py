...
class CreatePaymentCheckoutSessionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["quantity", "purchase_amount", "product_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if purchase_amount (nullable) is None
        # and model_fields_set contains the field
        if self.purchase_amount is None and "purchase_amount" in self.model_fields_set:
            _dict['purchase_amount'] = None

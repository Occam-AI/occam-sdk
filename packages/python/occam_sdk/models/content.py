...
CONTENT_ANY_OF_SCHEMAS = ["List[object]", "str"]
...
class Content(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Content with anyOf schemas: List[object], str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Content with anyOf schemas: List[object], str. Details: " + ", ".join(error_messages))
        else:
            return instance

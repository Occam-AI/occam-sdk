...
class RequestDemoContentResponse(BaseModel):
    """
    RequestDemoContentResponse
    """ # noqa: E501
    email: StrictStr
    name: StrictStr
    job_function: StrictStr
    use_case: StrictStr
    company_name: StrictStr
    company_size_range: StrictStr
    linkedin_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["email", "name", "job_function", "use_case", "company_name", "company_size_range", "linkedin_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "company_size_range": obj.get("company_size_range"),

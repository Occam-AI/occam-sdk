...
class RefreshResourcesRequest(BaseModel):
    """
    RefreshResourcesRequest
    """ # noqa: E501
    refresh_entry_point: RefreshEntryPoint
    __properties: ClassVar[List[str]] = ["refresh_entry_point"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "refresh_entry_point": obj.get("refresh_entry_point")
        })
        return _obj

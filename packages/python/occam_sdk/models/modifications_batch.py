...
class ModificationsBatch(BaseModel):
    """
    This is the model that is expected by the save and validate endpoint.
    """ # noqa: E501
    modifications: List[ModificationsBatchModificationsInner]
    modifier_id: Optional[StrictInt] = None
    modifier_type: PlanModifierType
    __properties: ClassVar[List[str]] = ["modifications", "modifier_id", "modifier_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "modifications": [ModificationsBatchModificationsInner.from_dict(_item) for _item in obj["modifications"]] if obj.get("modifications") is not None else None,
